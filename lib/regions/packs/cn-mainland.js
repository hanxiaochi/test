...
const navigation = require("./cn-mainland/navigation");
const { costCalculatorPageHtml } = require("./cn-mainland/pages/cost-calculator-page");
...
module.exports = Object.freeze({
  ...
  runtime: {
    pages: [
      { route: "/costBase/calculator_page", method: "all", render: costCalculatorPageHtml }
    ]
  }
});

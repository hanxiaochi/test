...
class SecurityStore {
  ...
  ensureBuiltinAuthorization(tenantId) {
    ...
    const grants = {
      admin: ["*"],
      editor: ["data:read", "data:write", "international:read", "international:calculate", "international:export"],
      viewer: ["data:read", "international:read", "international:calculate", "international:export"],
      certificate_approver: ["data:read", "international:read", "international:calculate", "international:export", "international:issue", "international:void"]
    };

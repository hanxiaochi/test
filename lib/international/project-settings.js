...
const TRANSLATIONS = Object.freeze({
  "zh-CN": {
    ...
    "international.applicationNo": "申请单号", "international.submitApplication": "提交证书申请", "international.applications": "证书申请台账", "international.applicant": "申请人", "international.approve": "批准", "international.return": "退回", "international.pending": "待审核", "international.approved": "已批准", "international.returned": "已退回",
    "international.contractEvents": "合同变更与索赔台账", "international.eventNo": "事件编号", "international.eventType": "事件类型", "international.variation": "变更", "international.claim": "索赔", "international.claimedAmount": "申报金额", "international.approvedAmount": "审定金额", "international.timeImpact": "影响工期(天)", "international.contractClause": "合同条款", "international.submitEvent": "提交合同事件", "international.decisionReason": "审定意见", "international.noticeDate": "通知日期", "international.description": "事件说明", "international.noEvents": "当前项目暂无合同事件", "international.remainingAmount": "可计金额"
  },
  "en-US": {
    ...
    "international.applicationNo": "Application no.", "international.submitApplication": "Submit certificate application", "international.applications": "Certificate applications", "international.applicant": "Applicant", "international.approve": "Approve", "international.return": "Return", "international.pending": "Pending review", "international.approved": "Approved", "international.returned": "Returned",
    "international.contractEvents": "Variations and claims register", "international.eventNo": "Event no.", "international.eventType": "Event type", "international.variation": "Variation", "international.claim": "Claim", "international.claimedAmount": "Claimed amount", "international.approvedAmount": "Approved amount", "international.timeImpact": "Time impact (days)", "international.contractClause": "Contract clause", "international.submitEvent": "Submit contract event", "international.decisionReason": "Decision reason", "international.noticeDate": "Notice date", "international.description": "Event description", "international.noEvents": "No contract events for this project", "international.remainingAmount": "Available amount"
  },
  "es-ES": {
    ...
    "international.applicationNo": "N.º de solicitud", "international.submitApplication": "Enviar solicitud de certificado", "international.applications": "Solicitudes de certificado", "international.applicant": "Solicitante", "international.approve": "Aprobar", "international.return": "Devolver", "international.pending": "Pendiente de revisión", "international.approved": "Aprobada", "international.returned": "Devuelta",
    "international.contractEvents": "Registro de variaciones y reclamaciones", "international.eventNo": "N.º de evento", "international.eventType": "Tipo de evento", "international.variation": "Variación", "international.claim": "Reclamación", "international.claimedAmount": "Importe reclamado", "international.approvedAmount": "Importe aprobado", "international.timeImpact": "Impacto de plazo (días)", "international.contractClause": "Cláusula contractual", "international.submitEvent": "Enviar evento contractual", "international.decisionReason": "Motivo de la decisión", "international.noticeDate": "Fecha de aviso", "international.description": "Descripción del evento", "international.noEvents": "No hay eventos contractuales para este proyecto", "international.remainingAmount": "Importe disponible"
  },
  "fr-FR": {
    ...
    "international.applicationNo": "N° de demande", "international.submitApplication": "Soumettre la demande de certificat", "international.applications": "Demandes de certificat", "international.applicant": "Demandeur", "international.approve": "Approuver", "international.return": "Renvoyer", "international.pending": "En attente d'examen", "international.approved": "Approuvée", "international.returned": "Renvoyée",
    "international.contractEvents": "Registre des variations et réclamations", "international.eventNo": "N° d'événement", "international.eventType": "Type d'événement", "international.variation": "Variation", "international.claim": "Réclamation", "international.claimedAmount": "Montant réclamé", "international.approvedAmount": "Montant approuvé", "international.timeImpact": "Impact délai (jours)", "international.contractClause": "Clause contractuelle", "international.submitEvent": "Soumettre l'événement contractuel", "international.decisionReason": "Motif de la décision", "international.noticeDate": "Date de notification", "international.description": "Description de l'événement", "international.noEvents": "Aucun événement contractuel pour ce projet", "international.remainingAmount": "Montant disponible"
  },
  "pt-BR": {
    ...
    "international.applicationNo": "N.º da solicitação", "international.submitApplication": "Enviar solicitação de certificado", "international.applications": "Solicitações de certificado", "international.applicant": "Solicitante", "international.approve": "Aprovar", "international.return": "Devolver", "international.pending": "Pendente de revisão", "international.approved": "Aprovada", "international.returned": "Devolvida",
    "international.contractEvents": "Registro de variações e reivindicações", "international.eventNo": "N.º do evento", "international.eventType": "Tipo de evento", "international.variation": "Variação", "international.claim": "Reivindicação", "international.claimedAmount": "Valor reivindicado", "international.approvedAmount": "Valor aprovado", "international.timeImpact": "Impacto no prazo (dias)", "international.contractClause": "Cláusula contratual", "international.submitEvent": "Enviar evento contratual", "international.decisionReason": "Motivo da decisão", "international.noticeDate": "Data da notificação", "international.description": "Descrição do evento", "international.noEvents": "Nenhum evento contratual para este projeto", "international.remainingAmount": "Valor disponível"
  },
  "ar-SA": {
    ...
    "international.applicationNo": "رقم الطلب", "international.submitApplication": "تقديم طلب الشهادة", "international.applications": "طلبات الشهادات", "international.applicant": "مقدم الطلب", "international.approve": "اعتماد", "international.return": "إرجاع", "international.pending": "قيد المراجعة", "international.approved": "معتمد", "international.returned": "معاد",
    "international.contractEvents": "سجل التغييرات والمطالبات", "international.eventNo": "رقم الحدث", "international.eventType": "نوع الحدث", "international.variation": "تغيير", "international.claim": "مطالبة", "international.claimedAmount": "المبلغ المطالب به", "international.approvedAmount": "المبلغ المعتمد", "international.timeImpact": "أثر المدة (أيام)", "international.contractClause": "بند العقد", "international.submitEvent": "تقديم حدث تعاقدي", "international.decisionReason": "سبب القرار", "international.noticeDate": "تاريخ الإشعار", "international.description": "وصف الحدث", "international.noEvents": "لا توجد أحداث تعاقدية لهذا المشروع", "international.remainingAmount": "المبلغ المتاح"
  }
});

const EVIDENCE_TRANSLATIONS = Object.freeze({
  "zh-CN": { evidence: "证据附件", upload: "上传证据", remove: "删除", empty: "暂无证据", locked: "已锁定" },
  "en-US": { evidence: "Evidence", upload: "Upload evidence", remove: "Delete", empty: "No evidence", locked: "Locked" },
  "es-ES": { evidence: "Pruebas", upload: "Subir prueba", remove: "Eliminar", empty: "Sin pruebas", locked: "Bloqueado" },
  "fr-FR": { evidence: "Preuves", upload: "Ajouter une preuve", remove: "Supprimer", empty: "Aucune preuve", locked: "Verrouillé" },
  "pt-BR": { evidence: "Evidências", upload: "Enviar evidência", remove: "Excluir", empty: "Sem evidências", locked: "Bloqueado" },
  "ar-SA": { evidence: "الأدلة", upload: "رفع دليل", remove: "حذف", empty: "لا توجد أدلة", locked: "مقفل" }
});
Object.entries(EVIDENCE_TRANSLATIONS).forEach(([locale, labels]) => Object.assign(TRANSLATIONS[locale], {
  "international.evidence": labels.evidence,
  "international.uploadEvidence": labels.upload,
  "international.deleteEvidence": labels.remove,
  "international.noEvidence": labels.empty,
  "international.evidenceLocked": labels.locked
}));

const NOTICE_TRANSLATIONS = Object.freeze({
  "zh-CN": { rule: "合同事件通知期限", enabled: "启用期限检查", variationDays: "变更通知期限(天)", claimDays: "索赔通知期限(天)", requireReason: "迟报必须说明", occurredDate: "事件发生日期", lateReason: "迟报原因", timeliness: "通知时效", timely: "及时", late: "逾期", notApplicable: "不适用", elapsedDays: "天" },
  "en-US": { rule: "Contract event notice periods", enabled: "Enable deadline check", variationDays: "Variation notice days", claimDays: "Claim notice days", requireReason: "Require late reason", occurredDate: "Occurrence date", lateReason: "Late notice reason", timeliness: "Notice timeliness", timely: "Timely", late: "Late", notApplicable: "Not applicable", elapsedDays: "days" },
  "es-ES": { rule: "Plazos de aviso contractual", enabled: "Activar control de plazo", variationDays: "Días para avisar variaciones", claimDays: "Días para avisar reclamaciones", requireReason: "Exigir motivo del retraso", occurredDate: "Fecha del evento", lateReason: "Motivo del aviso tardío", timeliness: "Plazo del aviso", timely: "En plazo", late: "Tardío", notApplicable: "No aplicable", elapsedDays: "días" },
  "fr-FR": { rule: "Délais de notification contractuelle", enabled: "Activer le contrôle du délai", variationDays: "Délai des variations (jours)", claimDays: "Délai des réclamations (jours)", requireReason: "Exiger le motif du retard", occurredDate: "Date de l'événement", lateReason: "Motif de notification tardive", timeliness: "Respect du délai", timely: "Dans les délais", late: "Tardive", notApplicable: "Sans objet", elapsedDays: "jours" },
  "pt-BR": { rule: "Prazos de notificação contratual", enabled: "Ativar controle de prazo", variationDays: "Dias para variações", claimDays: "Dias para reivindicações", requireReason: "Exigir motivo do atraso", occurredDate: "Data do evento", lateReason: "Motivo da notificação tardia", timeliness: "Prazo da notificação", timely: "No prazo", late: "Atrasada", notApplicable: "Não aplicável", elapsedDays: "dias" },
  "ar-SA": { rule: "مدد إشعار الحدث التعاقدي", enabled: "تفعيل فحص المهلة", variationDays: "مهلة إشعار التغيير بالأيام", claimDays: "مهلة إشعار المطالبة بالأيام", requireReason: "إلزام بيان سبب التأخير", occurredDate: "تاريخ وقوع الحدث", lateReason: "سبب تأخر الإشعار", timeliness: "توقيت الإشعار", timely: "ضمن المهلة", late: "متأخر", notApplicable: "غير منطبق", elapsedDays: "يوم" }
});
Object.entries(NOTICE_TRANSLATIONS).forEach(([locale, labels]) => Object.assign(TRANSLATIONS[locale], {
  "international.noticeRule": labels.rule,
  "international.noticeEnabled": labels.enabled,
  "international.variationNoticeDays": labels.variationDays,
  "international.claimNoticeDays": labels.claimDays,
  "international.requireLateReason": labels.requireReason,
  "international.occurredDate": labels.occurredDate,
  "international.lateNoticeReason": labels.lateReason,
  "international.noticeTimeliness": labels.timeliness,
  "international.notice.timely": labels.timely,
  "international.notice.late": labels.late,
  "international.notice.not_applicable": labels.notApplicable,
  "international.elapsedDays": labels.elapsedDays
}));
...
function boundedPositiveInteger(value, label, fallback) {
  const source = value === undefined ? fallback : value;
  const result = Number(source);
  if (!Number.isInteger(result) || result < 1 || result > 3650) throw new Error(`${label} must be an integer from 1 to 3650`);
  return result;
}

function strictBoolean(value, label, fallback) {
  const source = value === undefined ? fallback : value;
  if (typeof source !== "boolean") throw new Error(`${label} must be a boolean`);
  return source;
}
...
function normalizeContractEventNoticeRule(value = {}, current = {}) {
  if (!value || typeof value !== "object" || Array.isArray(value)) throw new Error("contract event notice rule must be an object");
  if (!current || typeof current !== "object" || Array.isArray(current)) throw new Error("current contract event notice rule must be an object");
  return {
    enabled: strictBoolean(value.enabled, "contract event notice rule enabled", current.enabled ?? true),
    variationNoticeDays: boundedPositiveInteger(value.variationNoticeDays, "contract event variation notice days", current.variationNoticeDays ?? 28),
    claimNoticeDays: boundedPositiveInteger(value.claimNoticeDays, "contract event claim notice days", current.claimNoticeDays ?? 28),
    requireLateReason: strictBoolean(value.requireLateReason, "contract event require late reason", current.requireLateReason ?? true)
  };
}
...
function normalizeProjectSettings(input = {}, current = {}) {
  ...
  return {
    ...
    contractEventNoticeRule: normalizeContractEventNoticeRule(input.contractEventNoticeRule ?? {}, current.contractEventNoticeRule ?? {}),
...
function settingsChecksum(settings, schemaVersion = 3) {
  const version = Number(schemaVersion);
  if (![1, 2, 3].includes(version)) throw new Error("unsupported international settings schema version");
  const payload = normalizeProjectSettings(settings);
  if (version === 1) delete payload.priceAdjustmentRule;
  if (version <= 2) delete payload.contractEventNoticeRule;
...
function activeSettingsVersion(state) {
  ...
  if (!active) return { version: 0, schemaVersion: 3, status: "legacy", settings: normalizeProjectSettings(state && state.internationalSettings || {}), checksum: settingsChecksum(state && state.internationalSettings || {}, 3) };
  return active;
}
...
function createSettingsVersion(state, input, metadata = {}) {
  ...
  const entry = { version: rows.reduce((max, row) => Math.max(max, Number(row.version) || 0), 0) + 1, schemaVersion: 3, status: "active", settings, checksum: settingsChecksum(settings, 3), changeReason: reason, createdBy: metadata.createdBy ?? null, createdAt: now, activatedAt: now };
...
module.exports = {
  ...
  decimalString,
  integerDigits,
  normalizeContractEventNoticeRule,

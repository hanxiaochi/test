...
function eventView(record) {
  if (!record || typeof record !== "object" || Array.isArray(record) || ![LEGACY_SCHEMA_VERSION, SCHEMA_VERSION].includes(record.schemaVersion)) throw new Error("contract event record is invalid");
...
function approveRecord(record, payload = {}, metadata = {}) {
  ...
  if (updated.schemaVersion >= SCHEMA_VERSION) {

...
const REPORT_TRANSLATIONS = Object.freeze({
  "en-US": {
    ...
    schemaVersion: "Schema version", eventId: "Event ID", supersedesEventId: "Supersedes event ID", submissionChecksum: "Submission SHA-256", decisionChecksum: "Determination SHA-256"
  },
  "zh-CN": {
    ...
    schemaVersion: "结构版本", eventId: "事件 ID", supersedesEventId: "替代事件 ID", submissionChecksum: "申报 SHA-256", decisionChecksum: "审定 SHA-256"
  },
  "es-ES": {
    ...
    schemaVersion: "Versión del esquema", eventId: "ID del evento", supersedesEventId: "ID del evento sustituido", submissionChecksum: "SHA-256 de la presentación", decisionChecksum: "SHA-256 de la determinación"
  },
  "fr-FR": {
    ...
    schemaVersion: "Version du schéma", eventId: "ID de l'événement", supersedesEventId: "ID de l'événement remplacé", submissionChecksum: "SHA-256 de la soumission", decisionChecksum: "SHA-256 de la détermination"
  },
  "pt-BR": {
    ...
    schemaVersion: "Versão do esquema", eventId: "ID do evento", supersedesEventId: "ID do evento substituído", submissionChecksum: "SHA-256 do envio", decisionChecksum: "SHA-256 da determinação"
  },
  "ar-SA": {
    ...
    schemaVersion: "إصدار البنية", eventId: "معرف الحدث", supersedesEventId: "معرف الحدث المستبدل", submissionChecksum: "SHA-256 للتقديم", decisionChecksum: "SHA-256 للقرار"
  }
});

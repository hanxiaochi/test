(function(config) {
	...
	function pa() {
		...
		return 0 <= a.indexOf("nvidia") || 0 <= a.indexOf("quadro") || 0 <= a.indexOf("geforce") || 0 <= a.indexOf("nvs") ?
			(b = ["nVidia"], 0 <= a.indexOf("geforce") && b.push("geForce"), 0 <= a.indexOf("quadro") && b.push("Quadro"), 0 <=
				...
				b.push("GE") : a.match(/fx\b/) && b.push("FX"), (c = a.match(na)) && c[1] && b.push(c[1].toUpperCase().replace(
					"GS", "")), 0 <= a.indexOf("titan") ? b.push("TITAN") : 0 <= a.indexOf("ti") && b.push("Ti"), b = b.join(" ")) :
			0 <= a.indexOf("amd") || 0 <= a.indexOf("ati") || 0 <= a.indexOf("radeon") || 0 <= a.indexOf("firegl") || 0 <= a.indexOf(
				"firepro") ? (b = ["AMD"], 0 <= a.indexOf("mobil") && b.push("Mobility"), c = a.indexOf("radeon"), 0 <= c && b.push(
					...
					"hd") &&
				b.push("HD"), 0 <= c && (a = a.substring(c)), (c = a.match(na)) && c[1] && b.push(c[1].toUpperCase().replace("HD",
	...
	g.AA = {
		...
		send: function() {
			...
			for (b in this.Ij)
				...
				} a.length && (a = ["type=nfl", "k=" + g.r.key, "m=" + (g.l.ba ? 1 : 0), "pf=" + g.l.Ez, "v=" + g.r.nn,
					"branch=JSAPI", "log=" + a.join("!")
				], a = g.r.vc + "://webapi.amap.com/count?" +
	...
	g.va = {
		...
		q: function(a, b) {
			...
			void 0 !== b && (b instanceof Array ? (c = b.slice(0), c.type = a) : "string" === typeof b || "number" === typeof b ||
				"boolean" === typeof b ? c.value = b : g.a.HJ(b) ? c.value = b : c = g.extend(c, b));
			for (var d = [].concat(this.of[a]), e = 0; e < d.length; e += 1) d[e].wb && (d[e].wb.call(d[e].cf || this, c), d[
				e] && d[e].Fj && this.of[a] && this.of[a].splice(e, 1));
			return this
		},
		wi: function(a) {
	...
	g.$e = {
		...
		get: function(a, b, c) {
			...
			if (e && e[a]) return c = e[a], c[d] ? (a = !1, !0 == c.D ? a = !0 : c.D = !0, b = c[d](b), a || (c.D = !1), b) :
				c.get(a, b);
			if (!c && this[d]) return a = !1, !0 == this.D ? a = !0 : this.D = !0, b = this[d](b), a || (this.D = !1), b;
	...
	g.r = {
		...
		key: "3adbc80950e306447ef70479a70197f8",
		vc: "http",
	...
	function nc(a) {
		...
		"https" === b && (g.r.cAa = "wss", g.r.Zd = g.r.Zd.replace("http", "https"), g.r.OD = g.r.OD.replace("http", "https"),
			g.r.WJ = g.r.WJ.replace("http", "https"), g.r.wU = g.r.wU.replace("http", "https"), g.r.SK = g.r.SK.replace("http",
				"https"), g.r.TK = g.r.TK.replace("http", "https"), g.r.TE = g.r.TE.replace("http", "https"), g.r.BL = g.r.BL.replace(
				"http", "https"), g.r.VI = g.r.VI.replace("http",
				"https"));
				...
				for (var a = window.localStorage.length; 0 <= a; a -= 1) {
					...
					if (b && "_AMap_" === b.slice(0, 6)) {
						var c = window.localStorage.getItem(b),
							c = JSON.parse(c || {});
						"_AMap_anole" === b ? c.version !== g.l.mf && window.localStorage.removeItem(b) : "_AMap_data.tileKeys" === b ?
							c.vdataVer === g.l.mf && c.apiVer === g.r.Hk || window.localStorage.removeItem(b) : c.version !== g.r.Hk &&
	...
	(function(a) {
		...
		a.a.HR = function(d, e) {
			...
			f.getCurrentPosition(function() {
				...
				l || (clearTimeout(k), k = void 0, 2 === b.code && 0 < b.message.indexOf("permission") ? a.sb.load(
					"AMap.GeoRemoteLoc",
					function() {
						d(null, a.paa, h)
					}) : d(null, f))
		...
		var b = a.da.extend({
			...
			z3: function(b) {
				...
				for (var d = 0, e = b.length; d < e; d++)
					if (a.o.hi && b[d] instanceof a.o.hi && b[d].ga && b[d].ga.length && (-1 !== b[d].ga.indexOf("building") || -
							1 !== b[d].ga.indexOf("poilabel")) && b[d].La) {
		...
		a.extend(e.prototype, {
				...
				if (!c.EX) {
					...
					a.l.JS ? this.Vja(function(a, b) {
						b ? this.rga(b, function(a, c) {
							a ? d(a) : (this.PB(c), this.EP = c, this.Qp.length = 0, this.no = null, d(null, {
								wma: b,
								$za: c
							}))
			...
			rga: function(a, b) {
				...
				if (e.qda) b.call(c, null, {
					...
					e.qda = !0;
					var f = [c.FY() + ":checkup", Math.random().toFixed(5) + "", Math.round(1E3 * Math.random()), !1, function(a,
						e) {
						var h = !0;
						...
						mta: function(a, b) {
							...
							if (!this.X4(a, function(a, b) {
								...
								q.onreadystatechange = function() {
									if (4 === q.readyState && 0 === q.status) q.Mt || (q.Mt = !0, f.Ml(l, b), q.onreadystatechange = null,
										k ? f.A0(q) : delete f.Wk[q.xE]), q = null;
									else if (!q.Mt)
										if (3 === q.readyState) {
											var h = q.responseText.substring(n);
											q.Oq = e(h, q.Oq);
											n = q.responseText.length
										} else 4 === q.readyState && (h = q.responseText.substring(n), a.bh && (h += "|"), e(h, q.Oq, !0), q.Oq =
											"", k ? f.A0(q) : delete f.Wk[q.xE],
											q = null)
								};
								q.onerror = function() {};
								q.open("GET", m, !0);
						...
						$D: function(a) {
							function b(d, p, r) {
								...
								if (d && "loaded" !== d.status && -1 !== m.indexOf(t))
									if ("limg" === t) p = h[1], d.qd = p, "string" === typeof p.b && (p.b = w.bB(p.b)), r = "", (r =
	...
	g.g = {
		...
		HD: function(a, b, c) {
			return a.parentNode == b ? !0 : a.parentNode && a.parentNode !== document.body && !g.g.Cn(a.parentNode, c) ? g.g.HD(
				a.parentNode, b) : !1
		},
		Mo: function(a) {
			if (!a) return [0, 0];
		...
		pJ: function(a) {
			if (a) return new g.xd(a.clientWidth || document.body.clientWidth, a.clientHeight || (g.l.Es ? "CSS1Compat" ===
		...
		UR: function(a) {
			...
			do {
				...
				b -= d.scrollTop || 0;
				c -= d.scrollLeft || 0;
				g.g.Toa() || !g.l.A$ && !k || (c += d.scrollWidth - d.clientWidth, k && "hidden" !== g.g.Vc(d, "overflow-y") &&
					"hidden" !== g.g.Vc(d, "overflow") &&
					(c += 17));
				d = d.parentNode
			} while (d);
			return new g.H(c, b)
		...
		Wa: function(a, b) {
			a && b && (a.classList && a.classList.add ? a.classList.add(b) : g.g.Cn(a, b) || (a.className += (a.className ?
				" " : "") + b))
		},
		pxa: function(a, b) {
			a && (a.className = b || "")
		...
		Z8: function(a, b, c) {
			a.cj = b;
			!c && g.l.UH ? (b = g.g.E4(b), c = a.style[g.g.tg].split("rotate"), 1 < c.length ? (c[0] = b, a.style[g.g.tg] = c
				.join("rotate")) : a.style[g.g.tg] = b, g.l.E6 && (a.style.WebkitBackfaceVisibility = "hidden")) : (a.style.left =
		...
		rotate: function(a, b, c) {
			...
			d ? (a.style[d] = "" + (" rotate(" + b + "deg)"), a.style[g.g.pt[d] + "-origin"] = c.x + "px " + c.y + "px") : (d =
		...
		A4: function(a, b, c) {
			...
			return d ? g.g.pt[d] + ":" + ("" + (" rotate(" + b + "deg)")) + ";" + (g.g.pt[d] + "-origin:" + c.x + "px " + c.y +
				"px") : ""
		},
		Am: function(a, b, c) {
			a.width = b;
	...
	g.F = {
		...
		Zxa: function(a) {
			...
			g.l.G6 && (g.F.h(a, "MSPointerDown", b, this), g.F.h(a, "MSPointerUp", b, this), g.F.h(a, "MSPointerMove", b,
				this))
		},
		...
		oxa: function(a) {
			return a && a.getBoundingClientRect ? (a.vM = a.getBoundingClientRect(), a.QW = [a.clientLeft, a.clientTop], !0) :
				!1
		},
		pza: function(a) {
		...
		nm: function(a, b) {
			...
			var c = document.body,
				...
				c = new g.H(g.l.Yf ? a.pageX : a.clientX + (c.scrollLeft || d.scrollLeft), g.l.Yf ? a.pageY : a.clientY + (c.scrollTop ||
					d.scrollTop));
	...
	g.extend(g.F, {
		...
		Ula: function(a, b, c, d) {
			...
			}, document.documentElement.addEventListener(this.Oo("pointerup"), a, !1), document.documentElement.addEventListener(
				this.Oo("pointercancel"), a, !1), this.d_ = !0);
			return this
		},
	...
	(function() {
		...
		g.extend(g.F, {
			...
			LGa: function(b, d) {
				...
				b.Ap.length || (c ? b.detachEvent("onresize", a) : (b.Bp.contentDocument.defaultView.removeEventListener(
					"resize",
			...
			if (1 === c.status) b && b();
				...
				try {
					if (g.l.Gv && window.localStorage) {
						var d = window.localStorage["_AMap_" +
							a];
						d && (d = JSON.parse(d), d.version === g.r.Hk ? (window._jsload_(a, d.script, !0), d.css && window._cssload_(a,
				...
				if (0 === c.status) {
					...
					f.ZS || (f.ZS = 1, window.setTimeout(function() {
						f.ZS = 0;
						var a = f.fua + "/modules?v=" + g.r.nn + "&key=" + g.r.key + "&m=" + f.Dz.join(",") + "&vrs=" + g.r.Hk;
						g.sb.Pt(f.Dz.join(","));
						f.Dz = [];
						c.XK = f.xta(a)
					}, 1));
	...
	window._cssload_ = function(a, b, c) {
		...
		e.type = "text/css"; - 1 === g.r.Fb.indexOf("webapi.amap.com") && (b = b.replace(/webapi.amap.com/gi, g.r.Fb.split(
			"://")[1]));
			...
			var s = g.indexedDB,
				...
				w = {
					...
					setItem: function(a, b, c) {
						var d = b;
						c && (d = JSON.stringify(b), 1.5 < d.length / 1024 / 1024 && Object.keys(b.cqa).length && (b.cqa = {}, d =
							JSON.stringify(b)));
						try {
			...
			g.Qj = {
				...
				get: function(c, d) {
					...
					s.get(z, {
						...
						if (b || c.length !== z.length) b && 3 === b.code ? q.Pi = !1 : e(), G = w, w = [], f(null);
						else {
							if (k)
				...
				sG: function() {
					...
					f.length ? (f.forEach(function(a) {
						...
						a ? 3 !== a.code ? e() : q.Pi = !1 : (u.data.keys = u.data.keys.concat(h), w.setItem(u.key, u.data, !0),
							c())
	...
	g.ne = g.da.extend({
		...
		Ai: function() {
			return new g.U(this.xc.R > this.oc.R ? (this.xc.R + this.oc.R + 360) / 2 % 360 : (this.xc.R + this.oc.R) / 2, (
				this.xc.Q + this.oc.Q) / 2)
		},
		extend: function(a) {
	...
	g.zp.rW = {
		...
		Zh: function(a, b) {
			for (var c = 180 / Math.PI, d = this.jM, e = this.kM, f = a.x * c / d, d = e / d, d = Math.sqrt(1 - d * d), e =
	...
	B.Rb = g.da.extend({
		...
		setVectorMapForeign: function(a) {
			if (g.l.Xp) {
				...
				g.sb.Jg(b, function() {
					d.o6(function() {
						d.map && (d.map.Hi = !0, d.map.GG && d.map.GG(), d.map.Te && d.map.Te instanceof g.Rb.DF && d.map.Te.ge &&
							d.map.Te.ge.S && (d.map.Te.ge.S.gI(), d.map.Te.ge.S.I6 = c, d.map.Te.ge.S.reload()), d.set("display"))
					})
				})
			}
		},
		setMapStyle: function(a) {
			...
			a = a || "normal"; - 1 === a.indexOf("amap://styles/") ? g.r.hK[a] ? this.set("styleUrl", "amap://styles/" + g.r
				.hK[a]) : this.set("styleUrl", "") : this.set("styleUrl", a);
			this.aT()
		},
		...
		setLang: function(a) {
			...
			"en" !== a && "zh_cn" !== a && "zh_en" !== a || a === this.get("lang", null, !0) || (this.set("lang", a), this.jk &&
				this.jk.y8(this))
		},
		getLang: function() {
		...
		getCity: function(a, b) {
			...
			var c = g.r.Zd + "/v3/geocode/regeo?&extensions=&&key=" + g.r.key + "&s=rsv3&output=json&location=" + (b || this
				.get("center", null, !0));
			(new g.jb.yb(c, {
				callback: "callback",
				gy: !0,
		...
		A: function(a, b) {
			...
			var c = this.w.zooms[1],
				d = this.w.zooms[0];
			b.zooms ? (b.zooms[0] = Math.max(d, b.zooms[0]), !0 === b.expandZoomRange && (c = g.l.ba ? g.l.Kc ? 19 : 20 : 20),
				...
				e.o6(function() {
					g.sb.Jg(f, function() {
						if (!e.get("destroy")) {
							...
							g.l.kl && e.Nla();
							e.D = !0;
							"3D" === e.view.type && (e.AmbientLight || (e.AmbientLight = new g.Sw.NV([1, 1, 1], 0.9)), e.DirectionLight ||
								(e.DirectionLight = new g.Sw.XV([0, -1, 1], [1, 1, 1], 0.1)));
							e.D = !1
						}
					})
				})
				...
				if (b)
					if (g.TJ = 0, g.SJ = 0, "string" == typeof b && "style_" == b.substr(0, 6)) {
						...
						32 == e.length ? (c.js = !0, g.r.Xpa = g.r.VI + "style_local/", d = g.r.vc +
							"://restapi.amap.com/v4/sdk/map/styles?styleid=" + e + "&key=" + g.r.key + "&sdkType=abroad_js_json&s=rsv3",
							d += "&platform=JS&logversion=2.0",
							d += "&appname=" + g.r.Up, d += "&csid=" + g.a.fF(), d += "&sdkversion=" + g.r.nn) : (c.js = !1, g.r.Xpa =
							g.r.VI + b + "/", d = g.r.Fb + "/styles/foreign/web_v8_" + b + ".json");
						...
						f.h("complete", function(b) {
							if (b && b.data && !b.data.IDa) {
								...
								}(d = b.style) && d.layers && (g.Jta = d.layers, b.zoomlevel && (g.TJ = b.zoomlevel[0], g.SJ = b.zoomlevel[
									1]))
		...
		Bta: function(a) {
			...
			if (g.l.Ie || g.Ve) a();
				...
				if (c) b(), a();
					...
					f.id = "amap_anole_js";
					f.src =
						window.__AMapStyleSource || g.r.vc + "://vdata.amap.com/style?v=" + g.r.nn + "&key=" + g.r.key +
						"&mapstyle=normal";
					c = document;
		...
		Ixa: function(a, b) {
			...
			for (f in a)
				...
				var f = {},
					h;
				for (h in d) d.hasOwnProperty(h) && (f[h] = "center" === h ? a[h].add(c[h].ab(a[h]).Nd(e)) : a[h] + (c[h] - a[
					h]) * e);
				return f
		...
		hQ: function() {
			...
			if (this.view && "3D" !== this.view.type) {
				...
				if (a && !("dv" < a)) {
					...
					b && c && (g.l.Xp && (d || "all" !== b || "normal" !== c && "amap://styles/normal" !== c) ? (this.set(
						"baseRender", "v"), this.vT = a) : this.vT && (this.set("baseRender", this.vT),
						this.vT = null));
					this.m5()
				}
			}
		...
		s$: function() {
			function a() {
				...
				if (g.a.ka(["d", "dv"], b.get("baseRender")) || !g.a.ka(["normal", "amap://styles/normal"], b.get("mapStyle")) ||
					"3D" === b.get("viewMode") && 0 < b.get("pitch") || "all" !== b.get("features") || b.get("editEnable") || !b.get(
						"turboMode")) a = !1;
				return a
			}
			if (!this.c8) {
		...
		fna: function(a) {
			...
			a.layers && 0 !== a.layers.length ? this.set("defaultLayer", a.layers[0], !0) : (b = new B.o.qb({
					innerLayer: !0
				}),
				a.layers = [b], b.LP = !0, this.set("defaultLayer", b, !0));
			if (b = a.view) b.w.rotation && (a.rotation = b.w.rotation), b.w.center && (a.center = b.w.center), b.w.zoom &&
				(a.zoom = Math.max(a.zooms[0], Math.min(a.zooms[1], b.w.zoom))), b.w.crs && (a.crs = b.w.crs);
		...
		tC: function(a) {
			...
			0 <= g.a.indexOf(b, a) || (a instanceof B.C.Vn ? (this.get("overlays").push(a), this.ry instanceof B.C.Vn && (
				this.ry.D = !0, this.ry.close(),
				this.ry.D = !1), this.ry = a, this.set("contextmenu", a, !0)) : (a instanceof B.C.Ze && (this.um instanceof B
				.C.Ze && this.Kz(this.um), this.um = a), this.get("overlays").push(a)), this.q("overlays"))
		},
		wk: function(a) {
			var b = this.get("layers"),
				c = g.a.indexOf(b, a);
		...
		getAllOverlays: function(a, b) {
			...
			if (a) {
				for (var d = "amap." + a.toLowerCase(), e = [], f =
						0; f < c.length; f += 1) d !== c[f].CLASS_NAME.toLowerCase() || !b && (c[f].Ca || c[f].isOfficial) || e.push(
					c[f]);
				return e
			}
			if (!b) {
			...
			e = [];
			if (d)
				for (var f = 0, h = d.length; f < h; f += 1) d[f] instanceof B.o.RL && e.push(d[f]), d[f].kb && (e = e.concat(d[
					f].kb));
			return c.concat(e)
		},
		...
		setFitView: function(a, b, c, d) {
			...
			if (a = this.o4(a)) {
				if (c = this.eJ(a, 0, new g.H(40, 40), c, d)) b = b || !this.getBounds().contains(a.Ai()) || g.l.ba && 1 < Math
					.abs(c[0] + this.get("zoom", null, !0)), this.setZoomAndCenter(c[0], c[1], b);
				this.D = !1;
				return a
			}
		},
		...
		queryObjectIndexFromFboByContainerPos: function(a, b) {
			...
			if (c) this.$G = this.view.Ne.cb(), this.ZG = this.view.cc.cb();
				...
				if (c = this.ZG.Yu(this.view.cc), c = !(this.$G.Yu(this.view.Ne) && c)) this.$G = this.view.Ne.cb(), this.ZG =
					this.view.cc.cb()
	...
	B.event = {
		...
		removeListener: function(a) {
			a instanceof
			g.tF && (g.a.Sh(a.Di.removeListener) ? a.Di.removeListener(a) : 0 === a.type ? g.F.G(a.Di, a.ZQ, a.fS, a.cf) : 1 ===
				a.type && (a.Di.ue || (a.Di.ue = g.va.ue), g.va.G.call(a.Di, a.ZQ, a.fS, a.cf)))
		},
		O: function(a, b) {
	...
	B.o.Yb = g.da.extend({
		...
		setMap: function(a) {
			...
			else if (b && (b.wk(this), this.set("map", null, !0), this.ti = !1, this.kg && this.kg(), this.onRemove)) this.onRemove()
		},
		getMap: function() {
			g.c.add(this, "getMap");
	...
	B.o.qb = B.o.Yb.extend({
		...
		A: function(a) {
			...
			this.mna(a);
			var b = a.zooms;
			b && b[1] >= this.ql[0] ? (b[0] < this.ql[0] && (b[0] = this.ql[0]), b[1] > this.ql[1] && (b[1] = this.ql[1])) :
				a.zooms = [this.ql[0], this.ql[1]];
				...
				if (this.Hq = !0, g.o.hi) {
					if ("dv" === c.get("baseRender") && !this.get("watermark")) {
						...
						b && (d.Kj = new g.o.od(new B.o.qb({
							...
							"opacity", "zIndex"
						], d, !0), d.Kj.BC(c.get("mapStyle") || "normal"));
						d.type = "\u6805\u683c\u5e95\u56fe";
						return d
					}
					if ("v" <= c.get("baseRender") || this.get("watermark")) return "3D" == a.B.view.type ? (c = new g.o.od(this,
							a, ["region", "road"]), c.type = "\u77e2\u91cf\u5e95\u56fe", b = new B.o.qb({
							zooms: [17, 20],
							zIndex: 50,
							innerLayer: !0
						}), c.Kj = new g.o.od(b, a, ["building"]), c.Kj.gf = 17, c.Kj.type = "\u697c\u5757\u56fe\u5c42", c.Kj.Yy =
						1, c.Kj.bf(["visible", "merge", "sort", "opacity"], c, !0), b.X("rejectMapMask", this, !0)) : (c = new g.o.od(
						this,
	...
	B.o.qb.KW = B.o.qb.extend({
		w: {
			getTileUrl: function(a, b, c) {
				return g.r.vc + "://tm.amap.com/trafficengine/mapabc/traffictile?v=1.0&t=1&zoom=" + (17 - c) + "&x=" + a +
					"&y=" + b
			},
			zooms: [6, 20],
			zIndex: 4,
		...
		fg: function(a) {
			...
			return "d" !== b.get("baseRender") ? g.o.$w ? a = new g.o.$w(this, a) : ["vt"] : a = new g.o.qb(this, a, null,
				this.w.maxDataZoom)
		}
	});
	...
	B.o.Qaa = B.o.Yb.extend({
		...
		A: function(a, b) {
			...
			g.c.ya(this, b);
			g.l.kl && (this.Cj = !0, b.size && (b.size = g.a.Mq(b.size)), this.D = !0, this.setData(a), g.a.tb(this, b), b.style ?
				(this.kf(this.w, !0), this.setStyle(b.style)) : this.setStyle(this.w), this.D = !1)
		},
		clear: function() {
			g.c.add(this, "clear");
		...
		setStyle: function(a) {
			...
			if (a instanceof Array) {
				for (var b = 0; b < a.length; b += 1) a[b].rotation_ = Math.PI * (a[b].rotation || 0) / 180, a[b].size = g.a.Mq(
					a[b].size), a.Df = Math.max(a.Df || 0, a[b].size.width + a[b].anchor.x), a.mg = Math.max(a.Df || 0, a[b].size
					.height + a[b].anchor.y);
				this.Em = a
			} else a.size && (a.size = g.a.Mq(a.size)), a.rotation_ = Math.PI * (a.rotation || 0) / 180, this.kf(a, !0),
				this.Em = {
		...
		setMap: function(a) {
			g.c.add(this, "setMap");
			g.l.kl && (a ? (this.get("map") && this.get("map").wk(this), this.set("map", a)) : this.get("map") && (this.get(
				"map").wk(this), this.set("map", null, !0), this.ti = !1, this.kg && this.kg()))
		},
		fg: function(a) {
	...
	B.o.qr = B.o.Yb.extend({
				...
				for (var b = 0; b < a.length; b++) {
					...
					if (c) {
						...
						d.text && (e.opts.text = d.text, d.text.content && (e.data.txt = d.text.content), (d = (d = e.opts.text.style) &&
							d.padding) && (e.opts.text.style.padding = this.qha(d)));
						this.ag.push(e);
						this.kb.push(c);
		...
		yG: function() {
			var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
			return this.Nf(a.width) || this.Nf(a.height) ? this.MZ(a) ? a.split(",") : this.yga(a) ? [a, a] : a : [a.width,
				a.height
			]
		},
		kfa: function() {
	...
	B.o.RL = B.o.CA.extend({
		...
		setMap: function(a) {
			g.c.add(this,
				"setMap");
			a ? (this.get("map") && (this.get("map").wk(this), this.C2 && B.event.removeListener(this.C2), this.U2 && B.event
				.removeListener(this.U2)), this.set("map", a)) : this.get("map") && (this.get("map").wk(this), this.Ce.map =
				null)
		},
		mapChanged: function() {
			this.get("map") && (this.get("map").SH(this), this.get("clickable") && (this.C2 = B.event.addListener(this.get(
				"map"), "click", this.Iua, this), this.U2 = B.event.addListener(this.get("map"), "dblclick", this.Jua, this)))
		}
	});
	B.C.Hh = g.da.extend({
		ka: [g.va, g.$e, {
		...
		setMap: function(a) {
			g.c.add(this, "setMap");
			a !== this.get("map", null, !0) && (a ? (this.get("map", null, !0) && this.get("map", null, !0).Kz(this), this.set(
				"map", a)) : this.get("map", null, !0) && (this.get("map", null, !0).Kz(this), this.set("map", null, !0)))
		},
		getMap: function() {
			g.c.add(this,
				"getMap");
	...
	B.C.Haa = B.C.Hh.extend({
		...
		setText: function(a) {
			...
			if (b) {
				var b = b.ag,
					c = this.yn(b, this); - 1 !== c && (b[c].data.txt = void 0 == a.content ? b[c].data.txt : a.content, b[c].opts
					.text = g.extend({}, b[c].opts.text, a), a.style && (b[c].opts.text.style = g.extend({}, b[c].opts.text.style,
						a.style)), this.f.Jo())
			}
		},
		setTop: function() {
	...
	B.C.Vn = B.C.Hh.extend({
		...
		open: function(a, b) {
			...
			b = g.a.Ja(b);
			this.set("position", b);
			this.map ? this.map && this.map !== a && (this.map.Kz(this), this.map = a, this.setMap(a)) : (this.map = a, this
				.setMap(a));
			this.q("open", {
				type: "open",
				target: this
	...
	B.C.Ze = B.C.Hh.extend({
		...
		open: function(a, b, c) {
			...
			if (a && !this.mL && (b =
				...
				d && d === a ? (this.set("altitude", c, !0), this.set("position", b)) : (this.map = a, a.um && a.um.close(),
		...
		getSerializedPath: function() {
			...
			for (var a = this.get("path", null, !0), b = [], c = 0, d = a.length; c < d; c++) {
				...
				if (e instanceof g.U) {
					var f = [];
					if (e.controlPoints)
						for (var h = 0, k = e.controlPoints.length; h < k; h++) f.push(e.controlPoints[h].DR()), f.push(e.controlPoints[
							h].AR());
					f.push(e.DR());
					f.push(e.AR());
					b.push(f)
	...
	B.C.Ec = B.C.hM.extend({
		...
		getBounds: function() {
			var a = this.get("path");
			if (a && a.length) {
				for (var a = this.fK(a), b = new g.ne(180, 90, -180, -90), c = 0, d = a.length; c < d; c += 1)
		...
		contains: function(a) {
			...
			for (var c = 0, d = b.length; c < d; c += 1) {
				for (var e = b[c], f = !1, h = 0, k = e.length; h < k && (f = this.ana(e[h]), g.wd.vq(f) || f.reverse(), f = g.wd
						.Sd(a, f, 0 === h ? !0 : !1), 0 < h && (f = !f), f); h += 1);
				if (f) return !0
			}
			return !1
		},
	...
	B.C.jh = B.C.ed.extend({
		...
		setCenter: function(a, b) {
			g.c.add(this, "setCenter");
			(a = g.a.Ja(a)) && a instanceof g.U && (this.C && this.C.get("deltaPos") && this.C.set("deltaPos", [0, 0], !0),
		...
		reset: function() {
			var a = this.get("center", null, !0);
			this.C && this.C.get("deltaPos") && (a = this.C.Tt([a], this.C.get("deltaPos"))[0], this.C.set("deltaPos", [0, 0],
				!0));
			this.set("center", a)
		},
	...
	B.C.TV = B.C.jh.extend({
		A: function(a) {
			...
			a = a || {};
			a.unit = "px";
			void 0 === a.radius ? a.radius = 20 : g.a.lk(a.radius, "string") && (a.radius = parseFloat(a.radius), isNaN(a.radius) &&
				(a.radius = 20));
	...
	function xc(a, b, c, d, e, f) {
		this.iE = [void 0 !== a ? a : new g.Vw, void 0 !== b ? b : new g.Vw, void 0 !== c ? c : new g.Vw, void 0 !== d ? d :
			new g.Vw, void 0 !== e ? e : new g.Vw, void 0 !== f ? f : new g.Vw
		]
	}
	g.cW = xc;
	xc.prototype = {
	...
	B.C.Et = B.C.Ec.extend({
		...
		Ur: function() {
			...
			if (c && d)
				for (var c = g.a.Ja(c), e = a.radius || this.get("radius"), f = d.Ab(c), a = f.x, f = f.y, h = g.a.map(e,
						function(a) {
		...
		setCenter: function(a, b) {
			g.c.add(this, "setCenter");
			(a = g.a.Ja(a)) && a instanceof g.U && (this.C && this.C.get("deltaPos") && this.C.set("deltaPos", [0, 0], !0),
				this.set("center", a), this.set("path", this.Ur()), this.dh || (this.dh = !0, this.get("map") && this.get(
					"map").q("overlays")),
	...
	B.C.Lt = B.C.Ec.extend({
		...
		setBounds: function(a) {
			var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
			g.c.add(this, "setBounds");
			a && a instanceof g.ne && (this.set("bounds", a), this.set("path", this.Ur()), this.dh || (this.dh = !0, this.get(
	...
	(function(a, b) {
		...
		a.C.dW = a.C.Yn.extend({
			...
			toGeoJSON: function() {
				...
				for (var a = this.$I(), c = [], d = 0, e = a.length; d < e; d++) a[d].D = !0, c[d] = a[d].toGeoJSON(), a[d].D = !
					1;
				return c
			},
			ega: function(a) {
			...
			Vca: function(c) {
				for (var d = "Feature" === c.type ? c.geometry : c, d = d ? d.coordinates : null, e = [], f = 0, n = d.length; f <
					n; f++) e.push(this.BX(b.extend({}, c, {
					type: "Feature",
					properties: {
						_isAmap: !0,
						_pointIndex: f,
			...
			CX: function(a) {
				for (var b = "Feature" === a.type ? a.geometry : a, b = b ? b.coordinates : null, c = [], d = 0, e = b.length; d <
					e; d++) c.push(this.w.coordsToLatLngs(b[d]));
			...
			Oca: function(c) {
				for (var d = ("Feature" === c.type ? c.geometry : c).geometries, e = [], f = 0, n = d.length; f < n; f++) e.push(
					this.RN(b.extend({}, c, {
						type: "Feature",
						properties: {
							_isAmap: !0,
		...
		a.C.Yn.Gb({
			toGeoJSON: function(a) {
				b.c.add(this, "toGeoJSON");
				a = a || this.$I();
				for (var e = [], f = 0, m = a.length; f < m; f++) a[f].toGeoJSON && (a[f].D = !0, e[f] = a[f].toGeoJSON(), a[f]
					.D = !1);
				this.D = !0;
				a = this.getExtData() || {};
				this.D = !1;
	...
	(function(a) {
		a.sF = function() {
				...
				if (a) {
					if (!C && u) {
						...
						do {
							...
							for (I = 0; A;) {
								...
								for (L = O; 0 < P || 0 < L && G;) 0 !== P && (0 === L || !G || A.z <= G.z) ? (z = A, A = A.pl, P--) : (z = G,
									G = G.pl, L--), H ? H.pl = z : E = z, z.jp = H, H = z;
								A = G
							}
							H.pl = null;
							O *= 2
					...
					for (E = a; a.Ia !== a.next;) {
						...
						if (u) a: if (H = a.Ia, I = a.next, 0 <= l(H, a, I)) H = !1;
								...
								P = h(H.x < a.x ? H.x < I.x ? H.x : I.x : a.x < I.x ? a.x : I.x, H.y < a.y ? H.y < I.y ? H.y : I.y : a.y < I
									.y ? a.y : I.y, f, r, u);
								O = h(H.x >
							...
							if (C)
								if (1 === C) {
									...
									E = e;
									A = a;
									do G = A.Ia, H = A.next.next, !m(G, H) && n(G, A, A.next, H) && p(G, H) && p(H, G) && (C.push(G.ve / E), C.push(
										A.ve / E), C.push(H.ve / E), s(A), s(A.next), A = a = H), A = A.next; while (A !== a);
									a = A;
									d(a, b, e, f, r, u, 2)
								} else {
									if (2 === C) a: {
															...
															if (A = !A)
																if (A = void 0, A = p(C, E))
																	if (A = void 0, A = p(E, C)) {
																		...
																		H = (C.x + E.x) / 2;
																		I = (C.y + E.y) / 2;
																		do A.y > I !== A.next.y > I && A.next.y !== A.y && H < (A.next.x - A.x) * (I - A.y) / (A.next.y -
																			A.y) + A.x && (G = !G), A = A.next; while (A !== C);
																		A = G
																	}
														} if (A) {
													a = q(C, E);
			...
			function p(a,
				b) {
				return 0 > l(a.Ia, a, a.next) ? 0 <= l(a, b, a.next) && 0 <= l(a, a.Ia, b) : 0 > l(a, b, a.Ia) || 0 > l(a, a.next,
					b)
			}
			...
			normalize: function(b) {
				...
				if (b) {
					...
					for (var f = 0, h = b.length; f < h; f += 1) c[f] = b[f] instanceof Array ? this.normalize(b[f]) : b[f] instanceof a
						.U ? [b[f].R, b[f].Q] : b[f] instanceof a.H ? [b[f].x, b[f].y] :
						b[f]
				}
				return c
			},
		...
		send: function(a, b, c, d) {
			...
			if (!this.w.gy || !this.gna()) {
				...
				window[f] = function(a) {
					...
					else if (3E4 === a.errcode && a.data) g.a.O8 = !0, g.sb.load("AMap.AntiCrabFrame", function() {
				...
				if (-1 !== a.indexOf(g.r.Zd + "/v") || -1 !== a.indexOf("yuntuapi.amap.com/datasearch") ||
					-1 !== a.indexOf("webapi.amap.com/")) b = b + "&platform=JS&logversion=2.0" + ("&appname=" + g.r.Up), b +=
					"&csid=" + g.a.fF(), b += "&sdkversion=" + g.r.nn;
				if (c = this.w.JI) {
					var l = [],
						m;
	...
	g.Rb = g.da.extend({
		...
		A: function(a, b) {
			...
			this.X("bounds", b);
			this.X("draw", b);
			this.bf("zoomAndCenter destroy defaultCursor jogEnable animateEnable baseRender overlayRender vectorMapForeign".split(
				" "), b);
		...
		styleUrlChanged: function() {
			if (this.B.Ei) {
				...
				if (a !== this.Dm) {
					...
					"normal" === c ? (this.Dm = "", this.set("nolimg", !!this.B.get("nolimg_param")), this.set("style", ""), this.Nu =
						"") : (this.hA = !0, this.set("nolimg", !0), b = new g.jb.yb(32 > c.length ? g.r.vc +
						"://webapi.amap.com/style?name=" + c + "&key=" + g.r.key : g.r.vc +
		...
		ina: function() {
			...
			if (!a.contains(b)) {
				...
				a.zj() < b.zj() ? c.R = a.Ai().R : (a.xc.R > b.xc.R && (c.R += a.xc.R - b.xc.R), a.oc.R < b.oc.R && (c.R += a.oc
					.R - b.oc.R));
				a.wj() < b.wj() ? c.Q = a.Ai().Q : (a.xc.Q > b.xc.Q && (c.Q += a.xc.Q - b.xc.Q), a.oc.Q < b.oc.Q && (c.Q += a.oc
					.Q - b.oc.Q));
				return c
			}
		},
		...
		psa: function() {
			...
			350 < g.g.pJ(this.K).width && (b.tn.innerHTML = this.B.w.copyright, b.tn.t6 = g.g.create("span", b.tn,
				"amap-mcode"), this.sE());
			this.Xa = b
		},
		sE: function() {
			...
			if (a) {
				...
				this.B.D = !1;
				"GS(2019)6379" === c && a && "normal" !== a && "amap://styles/normal" !== a && (c = "", this.Xa.tn.style.visibility =
					"hidden");
		...
		cU: function(a) {
			...
			c && (this.B.set("rasterLayer", void 0), this.B.c8 = !0, this.B.vk = this.B.La, this.yi && (this.yi.wD = !1), c.o &&
				(c.o.XD = !0), a || (this.dU = g.a.pU(function() {
					b.dU = null;
					b.B && b.B.wk(c)
				})));
		...
		Br: function() {
			function a() {
				for (var a = d.get("layers"), b = d.get("zoom"), c = 0; c < a.length; c += 1) {
					...
					if (!(a[c].Cj || a[c].vk || a[c].q5 || !e || b > e[1] || b < e[0] ||
							!a[c].get("visible") || a[c].o && a[c].o.ga && 0 === a[c].o.ga.length || a[c].o && a[c].o.XD || a[c].o && a[
								c].o.La)) return !1
				}
				a = d.B.get("features");
				return ("all" === a || g.a.ka(a, "point")) && d.Hc && d.Hc.get("visible") && 0 < d.Hc.ga.length && !d.Hc.La &&
					!d.Hc.ro ? !1 : !0
			}
			...
			if (!this.yI)
				if (this.LD) 1 === this.St && 13 === this.get("zoom") && (g.a.jD.stop(this.tG), g.Be.nf.send({
					id: this.B.id,
					params: {
						fps: this.tG.jD,
						type: "fps",
					...
					var d = this,
						...
						f = a();
					e ? (e.o && e.o.La && (this.B.La || c()), f && (this.B.La || c(), this.cU(), b())) : f && (this.B.La || c(), b(),
						this.B.c8 = !0)
				}
		},
		layersChanged: function() {
			this.la = this.la || [];
			for (var a = this.get("layers"), b = this.la.length - 1; 0 <= b; b -= 1) this.la[b] === this.td || this.la[b] ===
				this.Zs || this.la[b].yB || this.la[b].S.yB || -1 !== g.a.indexOf(a, this.la[b].S) || (this.la[b].kg(), this.la[
					b].Kj && this.la[b].Kj.kg(), this.la[b].S.G("complete", this.Br, this), this.la[b].S.G("renderComplete", this
					.Br, this), this.la = g.a.Ho(this.la, b));
			for (var c = !1, d = !0, e = this.get("labelzIndex"), b = 0; b < a.length; b += 1)
				if (!a[b].q5)
					...
					} for (b = 0; b < this.la.length; b += 1) f = this.la[b].S, f.Hq && f.get("visible") && (c = !0, !1 === f.get(
			...
			c && this.B.get("showLabel") ? (-1 === a && this.la.push(this.Hc), this.Hc.ja =
				d && g.l.ja, this.Hc.BC(this.get("mapStyle") || "normal"), this.Hc.set("zIndex", e), this.Hc.set("visible", !0),
				this.B.vD = !0, this.B.get("isHotspot") ? this.Hc.Qua() : this.Hc.nQ()) : (this.Hc && (this.Hc.set("visible",
				!1), this.B.vD = !1, this.Hc.nQ()), this.B.vD = !1);
		...
		v1: function() {
			if (!this.yI) {
				var a = this;
				this.A1 = !1;
				a.td || (a.td = new g.o.ed(new B.o.ed, a), a.td.Df = 36, a.td.mg = 36, a.td.set("zIndex", 120), a.la.push(a.td),
					a.td.XC = !0);
				for (var b = a.get("overlays"), c = [], d = 0; d < a.Xc.length; d += 1) - 1 === g.a.indexOf(b, a.Xc[d].Kb) && (
					a.Xc[d].Kb instanceof B.C.Ze || a.Xc[d].Kb instanceof B.C.Vn ? a.Xc[d].kg() : (a.td && a.Xc[d] instanceof g.C
						.ub ? (a.td.eh = g.a.zy(a.td.eh, a.Xc[d].L), a.td.j8([a.Xc[d].L])) : a.Zs && a.Zs.j8([a.Xc[d].L]), a.Xc[d].L
						.fa ? (g.g.remove(a.Xc[d].L.fa), a.Xc[d].L.fa = null) : a.Xc[d].L.Ma && (g.g.remove(a.Xc[d].L.Ma.Rh), g.g.remove(
							a.Xc[d].L.Ma.Rc), g.g.remove(a.Xc[d].L.Ma.dir), a.Xc[d].L.Ma = null), a.Xc[d].Jn && a.Xc[d].Jn.stop(), a.Xc[
							d].Bh && a.Xc[d].Bh.stop(), a.Xc[d].Kb.ti = !1, a.Xc[d].Kb.Al(), a.Xc[d].Kb.C = null, a.Xc[d].Kb = null, a.Xc[
							d].L.Ooa(), a.Xc[d].L = null, a.Xc[d].Al(), a.Xc[d].Ce = null, a.Xc[d].wi(), a.Xc[d].map = null), c.push(a.Xc[
						d]));
				...
				g.a.kxa(function(b) {
					if (!b.ti && b.dh) {
						var c = b.C || a.Pma(b);
						c && (a.Xc.push(c), c instanceof g.C.Ze || c instanceof g.C.Vn ? c.Ts(a) : c instanceof g.C.ub ? e.push(c.L) :
							f.push(c.L), b.ti = !0)
					}
				}, b);
				e.length && a.td.ay(e);
		...
		Pma: function(a) {
			...
			if (a instanceof B.C.ub) b = new g.C.ub(a, this);
				...
				var c = ["overlay"];
				"d" === this.get("overlayRender") ? (c.push("dvector"), g.l.Gn ? c.push("svg") : c.push("vml")) : c.push(
					"cvector");
				...
				a instanceof B.C.Ec ? b = new g.C.Ec(a, this) : a instanceof B.C.tA ? b = new g.C.tA(a, this) : a instanceof B.C
					.Zb ? b = new g.C.Zb(a, this) : a instanceof B.C.jh ? b = new g.C.jh(a, this) : a instanceof B.C.Et ? b = new g
					.C.Ec(a, this) :
		...
		L3: function() {
			var a = this.De;
			this.Nu && (!this.Te || !this.Te.Hp || this.B && this.B.js) && (a = "function" === typeof this.Nu ? this.Nu(this
				.yi.P.zoom) : this.Nu);
			return a
		},
		FCa: function() {
		...
		pc: function() {
			...
			if (!this.yI) {
				...
				if (this.la && (a.size = this.B.get("size"), a.size.width && a.size.height)) {
					for (var b = this.B.view.type, c = [], d = 0, e = this.la.length; d < e; d += 1) this.la[d].Kf && this.la[d].Kf !==
						b ? this.la[d].La = !0 : (c.push(this.la[d]), this.la[d].Kj && c.push(this.la[d].Kj));
					c.sort(function(a, b) {
						var c = a.get("zIndex"),
							d = b.get("zIndex");
					...
					a.mua = !0;
					a.ZH = this.ZH;
					for (var b = !1, f, c = !1, d = 0; d < this.la.length; d += 1) this.la[d].Fi && this.la[d].S.get("visible") &&
						a.P.zoom <= this.la[d].S.get("zooms")[1] && (a.hU = !0), this.la[d].le().Kc && (b = !0);
					for (d = 0; d < this.la.length; d += 1) this.la[d].S.SP && a.hU && (!this.gj && this.la[d].S.get("visible") &&
						(f = this.la[d].S.SP(), f.fFa = 1, f.zoom = a.P.zoom), c = !0);
					this.nb = [];
		...
		Qq: function(a) {
			if (!this.yI) {
				...
				if (this.la && (b.size = this.B.get("size"), b.size.width && b.size.height)) {
					for (var c = this.B.view.type, d = [], e = 0, f = this.la.length; e < f; e += 1) this.la[e].Kf && this.la[e].Kf !==
						c || !(this.la[e] instanceof g.o.Pm) || 0 > a.indexOf(this.la[e].S) || (d.push(this.la[e]), this.la[e].Kj &&
							d.push(this.la[e].Kj));
					d.sort(function(a, b) {
						var c = a.get("zIndex"),
							d = b.get("zIndex");
		...
		destroyChanged: function() {
			...
			this.cU(!0);
			this.V = {};
			this.Hc && (this.Hc.S.G("complete", this.Br, this), this.Hc.kg(), this.la = g.a.Ho(this.la, g.a.indexOf(this.la,
				this.Hc)));
		...
		drawChanged: function() {
			...
			if (d) {
				...
				for (b = 0, c = this.uq.length; b < c; b += 1) this.uq[b].swa(), this.uq[b].bDa(), this.G("click", this.uq[b].NEa,
					this)
		},
		Xd: function(a, b, c) {
		...
		C4: function(a, b) {
			...
			d.width = a;
			d.height = b;
			for (var e = -(c.width - a) / 2, c = -(c.height - b) / 2, f = d.getContext("2d"), h = this.Xa.o.childNodes, k = [],
	...
	g.Rb.Gb({
		...
		zoomEnableChanged: function() {
			this.get("zoomEnable") ? (g.l.Yf && this.UP && "3D" !== this.B.view.type && this.UP(), g.l.ba || this.Bca()) : (
				g.l.Yf && this.jT && this.jT(),
				g.l.ba || this.i_())
		},
		...
		Ni: function(a, b, c, d) {
			...
			f.Tf = this.Od(f.Sa);
			c || (c = this.DB ? this.DB ? [this.DB] : null : this.Yea(f.Sa, d)) && 0 < c.length && c[0].wo && (e = c[0].wo,
				f.su = c[0]);
			e || "info" === a.af || (e = this);
			f.hd = e;
			f.GBa = a.altKey;
			...
			f.button = void 0 ===
				a.button ? 0 : a.button;
			f.wT = a;
			e && "AMap.LabelMarker" === e.CLASS_NAME && (f.lnglat = f.Tf, f.pixel = f.Bb, f.target = e, f.data = e.TW, f.originEvent =
				a);
		...
		WO: function() {
			var a = this.V;
			a.jg && (a.dk.Bb.x === a.jg.x && a.dk.Bb.y === a.jg.y ? a.Of = !1 : (a.Of = !0, a.Ep || (a.kq.q("dragstart", a.jq),
				a.Ep = !0), a.kq.q("dragging", a.dk), a.jg = a.dk.Bb))
		},
		Rxa: function(a) {
	...
	g.Rb.Gb({
		...
		JM: function() {
			this.YC && ("3D" === this.B.view.type ? (this.h("dragstart", this.E_), this.h("dragging", this.A_), this.h(
				"dragend", this.C_)) : (this.h("dragstart", this.D_), this.h("dragging", this.z_), this.h("dragend", this.B_)))
		},
		DO: function() {
			this.YC || ("3D" === this.B.view.type ? (this.G("dragstart", this.E_), this.G("dragging", this.A_), this.G(
				"dragend", this.C_)) : (this.G("dragstart", this.D_), this.G("dragging", this.z_), this.G("dragend", this.B_)))
		},
		D_: function(a) {
			this.YS(a);
			this.nu();
		...
		z_: function() {
			...
			if (c || b) {
				...
				this.vv && (this.kh ? (a = new Date, this.Zt = 100 < a - this.kh ? new g.H(0, 0) : new g.H(b, c), this.kh = a) :
					this.kh = new Date);
				this.qa("dragging");
				this.qa("mapmove")
		...
		HV: function() {
			if (g.l.Yl && (g.l.vL || g.l.YH)) {
				...
				for (b = 0; b < this.la.length; b += 1) c = this.la[b], "undefined" !== typeof AMap.IndoorMap && c instanceof AMap
					.IndoorMap &&
	...
	g.uM = g.MW.extend({
		...
		H6: function(a) {
			for (var b = this.get("centerCoords"), c = g.a.dc.x, d = g.a.dc.y, e = this.get("size"), f = g.a.Fa, h = b.x + f /
					2, b = b.x - f / 2, k = [], l = new g.Hl([0, 0, 0, 1]), m = l.elements, n = new g.H(0, 0), p = g.Dc.multiply(
						this.Ne, this.cc), q = 0, r = a.length; q < r; q++)
				if (a[q]) {
	...
	g.Rb.Gb({
		...
		rA: function(a, b, c, d) {
			...
			if (e !== a) {
				...
				c = function(c) {
					...
					c === a && a << 0 === a && (this.set("targetLevel", null), h && !this.jF && (this.qa("zoomchange"), this.qa(
						"zoomend")), this.q("zoomend"), k && this.q("moveend"), this.Zf = null)
				};
				var m;
				this.Fd && this.Fd.Zv && (this.Fd.stop(), this.Fd.hS && (d = !0), this.Fd.tD && (m = !0), this.Fd = null, this.set(
					"targetLevel",
					null));
				this.Zf && this.Zf.Zv && (this.Zf.stop(), d = !0, this.Zf.tD && (m = !0), this.Zf = null, this.set(
					"targetLevel", null));
				h && !d && this.qa("zoomstart");
				k && !m && this.qa("movestart");
				this.q("zoomstart");
				b ? c.call(this, a) : (this.Zf = new g.Nj(e, a, null, 0.04), this.Zf.hS = h, this.Zf.tD = k, this.Zf.transition =
					function(a, b, c) {
		...
		ZK: function(a, b, c, d) {
			...
			var e = b ? this.Ab(b).toFixed(3) : this.Fd ? this.Fd.D9 : this.get("centerCoords"),
				...
				k = b = !1;
			this.Zf && this.Zf.Zv && (this.Zf.stop(), b = !0, this.Zf.tD && (k = !0), this.Zf = null, this.set("targetLevel",
				null));
			this.Fd && this.Fd.Zv && (this.Fd.stop(), this.Fd.hS && (b = !0), this.Fd.tD && (k = !0), this.Fd = null, this.set(
				"targetLevel", null));
			this.Je && (this.Je.stop(), this.Je = null);
			if (f || h) {
				if (!this.B.view.lm().contains(e) || f && "3D" !== this.B.view.type && (g.l.ba || g.l.Ie)) c = !0;
				if (c) f && (b ||
					(this.q("zoomstart"), this.qa("zoomstart")), this.set("zoom", a), this.qa("zoomchange"), this.qa("zoomend"),
					this.q("zoomend")), h && (k || d || (this.qa("movestart"), this.q("movestart")), this.set("centerCoords", e),
					...
					this.Fd.Kq = function(b) {
						0.02 > b ? (this.Fd && (this.Fd.stop(), this.Fd = null), f && (this.set("zoom", a), this.qa("zoomchange"),
							this.qa("zoomend"), f = !1, this.q("zoomend")), h && (this.set("centerCoords", e), this.q("mapmove"),
							this.q("moveend", {
								L5: d
							})), this.set("targetLevel", null)) : (f && this.set("zoom", a - l * b), h && (b = e.ab(m.Nd(b)).toFixed(3),
							this.set("centerCoords", b), this.qa("mapmove")));
						this.set("display", 1)
					};
					this.Fd.Pn(this);
	...
	g.o.Yb = g.da.extend({
		...
		dJ: function() {
			...
			if (a) {
				...
				} else a instanceof g.$f ? this.I = [a.kc.x, a.kc.y, a.Vd.x, a.Vd.y] : a instanceof g.PF && "3D" === this.S.Kf &&
					(b = a.path[1], d =
	...
	g.sg = g.da.extend({
		...
		set: function(a, b) {
			var c = this.tY(a);
			c ? c.value = b : (c = new g.sg.tr(a, b), this.e[a] = c, this.tB(c), this.count += 1, this.count > this.Ip &&
				this.q1(this.Ip))
		},
		yw: function(a) {
			this.remove(a)
		...
		nza: function(a) {
			a = new g.sg.tr("", a);
			0 === this.count ? (this.cd.Ia = null, a.Ia = this.cd, this.jC = this.cd.next = a) : (this.cd.next.Ia = a, a.next =
				this.cd.next, a.Ia = this.cd, this.cd.next = a);
			this.count += 1
		},
		pua: function() {
			if (this.count) {
		...
		tB: function(a) {
			this.VF ? (a.next = this.cd.next, a.Ia = this.cd, this.cd.next = a, a.next.Ia = a) : (a.Ia = this.cd.Ia, a.next =
				this.cd, this.cd.Ia = a, a.Ia.next = a)
		},
		q1: function(a) {
			if (!(this.count <= a || this.count < 2 * this.CB.length)) {
				for (var b = this.VF ? this.cd.Ia : this.cd.next, c = {}, d = 0, e = this.CB.length; d < e; d++) c[this.CB[d]] = !
					0;
				for (a = Math.ceil(2 * a / 3); b && this.count > a && (d = this.VF ? b.Ia : b.next, b.key && !c[b.key] && this.UB(
							b) && this.mK(b.value),
	...
	g.xF = g.da.extend({
		...
		bea: function(a) {
			...
			a.startTime = +new Date;
			a.QK = !0;
			b.complete ? Qc(a, !0) : (this.Nn.set(a.url, a), b.onload = Pc(a, !0), b.onerror = Pc(a, !1, !0), b.onabort = Pc(
				a, !1), a.vya = setTimeout(Pc(a, !1, !0), this.timeout))
		},
		dX: function(a) {
	...
	g.o.qb = g.o.Yb.extend({
		...
		tileFunChanged: function() {
			...
			this.Do = function(b, c, d) {
				...
				if (!b.Is || b.Is.sn) b.loaded = !1, b.Is = ("3D" === this.e.B.view.type ? g.sm.sta : g.sm.nz).call(g.sm, e,
					function(a) {
						b.Is = null;
						a ? c(a) : d()
					}, !1)
	...
	g.o.ed = g.o.Yb.extend({
		A: function(a, b) {
			...
			this.Jv = [];
			this.fm = new g.o.kaa;
			a && (this.X("style", a), this.X("cursor", a, !0), this.Uxa = a.get("stable") || !1, this.X("dataSources", a),
				this.X("bubble", a));
			this.X("display", b);
			this.wca()
		},
		...
		dataSourcesChanged: function() {
			...
			a && a.length ? "string" === typeof a ? (new g.jb.yb(a)).h("complete", function(a) {
				...
				this.La = !0;
				this.S.q("complete")
			}, this) : a.length && (this.x7(a), this.ls = a, this.pm = !0, this.set("display"), this.La = !0, this.S.q(
				"complete")) : this.clear()
		},
		getDatas: function() {
			return this.ls
			...
			if (a) {
				...
				if (a.rules) {
					for (var b = a.rules, d = 0, e = b.length; d < e; d += 1) {
						for (var f = [], h = b[d].symbolizers, k = 0, l = h.length; k < l; k += 1) h[k].fill && (f[k] = new g.style.Qg
							.aW(h[k].fill)), h[k].stroke && (f[k] = new g.style.Qg.FW(h[k].stroke));
						h = f;
						b[d].iL = h;
		...
		fwa: function(a) {
			"px" === a.target.get("unit") ? (this.Df = Math.max(a.vl, this.Df), this.mg = Math.max(a.vl, this.mg)) : a.vl >
				this.Ns && (this.Ns = a.vl, this.qz = this.Ns / this.map.B.pj.oq(20))
		},
		RH: function(a) {
			this.fm.add(a);
			if (!this.XC &&
				...
				if (0 === a.name.indexOf("circle") || 0 === a.name.indexOf("ellipse")) {
					...
					"px" === a.get("unit") ? (this.Df = Math.max(b, this.Df), this.mg = Math.max(b, this.mg)) : this.Ns ? b > this
						.Ns && (this.Ns = b, this.qz = this.Ns / this.map.B.pj.oq(20)) : (this.Ns = b, this.qz = this.Ns / this.map.B
							.pj.oq(20))
				}
		...
		am: function(a) {
			return this.XC ? new g.M.Me.Il(this, a) : "c" === this.map.get("overlayRender") && g.M.canvas.Il ? new g.M.canvas
				.Il(this, a) : g.M.ae.Il && "d" === this.map.get("overlayRender") ? new g.M.ae.Il(this, a) : null
		}
	});
	g.o.ed.Gb({
		bm: function(a) {
	...
	g.o.kaa = g.da.extend({
		...
		add: function(a) {
			var b = g.a.xb(a),
				c = a.fc();
			this.sq[b] || (this.count += 1, this.sq[b] = a, c && !g.I.gb(c.Kd(), [Infinity, Infinity, -Infinity, -Infinity]) &&
				this.NT.Gs(c.Kd(), a))
		},
		pEa: function() {
			return this.sq
	...
	g.Ok = g.da.extend({
			...
			do {
				...
				for (var h = f.length - 1; 0 <= h; h -= 1) {
					...
					var l = g.Ok.Uz(k.I[2] - k.I[0], k.I[3] - k.I[1], k.Ib.length + 1),
						k = g.Ok.Uz((k.I[2] > a.I[2] ? k.I[2] : a.I[2]) - (k.I[0] < a.I[0] ? k.I[0] : a.I[0]), (k.I[3] > a.I[3] ? k.I[
								3] : a.I[3]) -
			...
			if (0 === b.Ib.length) b.I = g.I.cb(a.I), b.Ib.push(a);
				...
				do {
					...
					if ("undefined" !== typeof e.We || "undefined" !== typeof e.Ib || f) {
						...
						else e = f = this.hta(c.Ib), 1 > d.length && (c.Ib.push(f[0]), d.push(c), e = f[1])
		...
		Jva: function(a, b, c) {
			for (var d = g.Ok.Uz(b.I[2] - b.I[0], b.I[3] - b.I[1],
					b.Ib.length + 1), e = g.Ok.Uz(c.I[2] - c.I[0], c.I[3] - c.I[1], c.Ib.length + 1), f, h, k, l = a.length - 1; 0 <=
				l; l -= 1) {
				var m = a[l],
			...
			d = a.splice(h, 1)[0];
			b.Ib.length + a.length + 1 <= this.ZJ ? (b.Ib.push(d), g.I.extend(b.I, d.I)) : c.Ib.length + a.length + 1 <=
				this.ZJ ? (c.Ib.push(d), g.I.extend(c.I, d.I)) : (k.Ib.push(d), g.I.extend(k.I, d.I))
		},
		remove: function(a, b) {
			var c = [];
			c[0] = {
			...
			do {
				...
				if ("undefined" !== typeof b)
					for (; 0 <= k;) {
						var l = c.Ib[k];
						if (g.I.ah(a, l.I))
							if (b && "undefined" !== typeof l.We && l.We === b || !b && ("undefined" !== typeof l.We || g.I.K2(a, l.I))) {
						...
						h.length = 0;
						0 === d.length && 1 >= c.Ib.length ? (h = this.Oz(c, !0, h, c), c.Ib.length = 0, d.push(c), e.push(1)) : 0 <
							d.length && c.Ib.length < this.ZJ ? (h = this.Oz(c, !0, h, c), c.Ib.length = 0) : h = void 0
					} else g.Ok.XT(c)
			} while (0 < d.length);
			return f
		},
			...
			do {
				...
				for (var l = d.length - 1; 0 <= l; l -= 1) {
					...
					if (g.I.ah(a.I, m.I))
						...
						if (b) c.push(m);
						else if ("undefined" === typeof e || m.type === e) m = m.We, "undefined" !== typeof f ? h[g.a.xb(m)] = m : c.push(
						m)
				}
			} while (0 < k.length);
	...
	g.C.Hh = g.da.extend({
		...
		du: function(a) {
			...
			if ("2D" == b) {
				...
				this.$o(new g.H(e, b));
				this.qa("dragging", a)
			} else "3D" == b && a.Sa && (c = a.Bb.ab(this.jg), b = c.x, c = c.y, e = a.Sa.ab(this.X5), a.Tf.ab(this.W5),
				this.jg = a.Bb, "function" === typeof this.sz && this.sz(b,
		...
		Tt: function(a, b) {
			...
			if (e)
				for (var e = 0, f = a.length; e < f; e++) {
					...
					for (e = 0, f = a.length; e < f; e++) h = c.Ab(a[e]), h.x += b[0], h.y += b[1], d.push(c.Od(h));
			return d
		}
	});
	g.C.ub = g.C.Hh.extend({
		...
		raiseOnDragChanged: function() {
			this.get("raiseOnDrag") ? (this.h("dragstart", this.u0, this), this.h("dragging", this.vg, this), this.h(
				"dragend", this.hY, this)) : (this.G("dragstart",
		...
		offsetChanged: function() {
			...
			if (this.map)
				if (this.L && this.L.fa) {
					...
					"2D" == c ? (c = this.map.Ab(this.get("position")), c = c.ab(this.L.Na).kd(Math.pow(2, 20 - this.map.get(
						"zoom"))), this.L.fa && (this.L.fa.LB && this.L.fa.parentNode !== this.L.fa.LB ? this.map.set("display") :
						a(c))) : "3D" == c && (c = this.get("position"), c =
						this.map.Ls(c, this.get("altitude")), this.L.fa && (this.L.fa.LB && this.L.fa.parentNode !== this.L.fa.LB ?
							this.map.set("display") : a(c)))
		...
		titleChanged: function() {
			this.L && this.L.Wg && "string" === typeof this.get("title") && this.L.Wg && this.get("title") && (this.L.Wg.title =
				this.get("title"))
		},
		wL: function(a, b) {
			a = a || this.get("label");
		...
		labelChanged: function(a) {
			...
			if (this.L && this.L.fa) {
				...
				a && a.content && (c = "", a.content && (c = this.ZP(a.content), b.appendChild(c), this.wL(a, c)), this.set(
					"labelDom", c))
		...
		isTopChanged: function() {
			var a = this.map.td.nL,
				b = this.get("isTop"),
				c = this.get("zIndex");
			a ? a === this ? this.L && this.L.fa && (this.L.fa.style.zIndex = b ? this.map.td.fr + 10 : c, this.map.td.nL =
				b ? this : null) : (a.L && a.L.fa && (a.L.fa.style.zIndex = b ? a.get("zIndex") : this.map.td.fr + 10), this.L &&
				this.L.fa && (this.L.fa.style.zIndex = b ? this.map.td.fr + 10 : c), this.map.td.nL = b ? this : a) : (this.map
				.td.nL = this, this.L && this.L.fa && (this.L.fa.style.zIndex = b ? this.map.td.fr + 10 : c))
		},
		visibleChanged: function() {
			this.L && this.L.fa && (this.get("visible") && !this.Kb.get("outOfZooms") ? this.L.fa.style.display = "block" :
		...
		YP: function(a, b) {
			...
			a ? ("string" === typeof a ? (c = a, n = !0) : (c = a.get("image"), e = a.get("size"),
					f = a.get("imageSize"), d = e.width, e = e.height, f && (l = f.width, m = f.height)), f = "string" !== typeof a ?
				a.get("imageOffset") : {
					x: 0,
					y: 0
		...
		moveChanged: function() {
			...
			void 0 !== a && ("pause" === a.action ? this.Gva() : "[object Array]" === Object.prototype.toString.call(a.Tf) ?
				a.Tf && ("resume" === a.action && this.PG ? this.moveTo(a.Tf[a.Tf.Kp || 0], a.speed, a.wb) : (this.PG && this.q(
					"movestop"), a.Tf.Kp = 0, this.set("position", a.Tf[0]), this.iua(a.Tf, a.speed, a.wb, a.sna))) : this.moveTo(
					a.Tf, a.speed, a.wb, !0))
		},
		moveTo: function(a, b, c, d) {
			if (!(0 >= b)) {
				...
				this.get("autoRotation") && !g.l.Ie && (b = "2D" == (this.map.B.view.type || "2D") ? this.Vea(e, a) : this.Wea(
		...
		iua: function(a, b, c, d) {
			...
			function f() {
				a.Kp < a.length - 1 ? (a.Kp += 1, this.moveTo(a[a.Kp], b, c)) : (this.qa("movealong"), d ? (a.Kp = 0, this.set(
					"position", a[0]), this.moveTo(a[a.Kp], b, c)) : this.q("movestop"))
			}
	...
	g.C.Vn = g.C.Hh.extend({
		...
		Gm: function() {
			var a =
				this.map,
				b = this.K;
			a && b && (this.map.get("zoom"), b = this.get("position"), b = a.Ls(b), a = b.y, b = b.x, this.K.style.right =
				"", this.K.style.bottom = "", this.K.style.left = b + "px", this.K.style.top = a + "px")
		},
		kg: function() {
			this.K && (this.map.G("click", this.OBa, this), this.map.Xa.C.removeChild(this.K), this.Sp.ti = !1, this.K =
				this.Sp.Ce.map = null, this.map.G("movestart", this.bn, this), this.map.G("zoomstart", this.bn, this), this.map
				.G("click", this.bn, this), this.map.G("closeOverlays", this.bn, this), this.map.G("rotate", this.bn, this))
		},
		visibleChanged: function() {
	...
	g.C.Ze = g.C.Hh.extend({
		...
		lX: function() {
			if (this.get("position") && this.get("autoMove") && this.sh) {
				for (var a = this.map, b = new g.xd(this.sh.offsetWidth, this.sh.offsetHeight), c = a.Ls(this.get("position"),
							this.get("altitude")).add(this.yda()), d = c.add(b.PE()), e = a.get("size"), f = a.sqa(),
						h = 0, k = 0, l = 0; l < f.length; l += 1) {
					var m = f[l],
						n = 0,
						p = 0;
					0 === m[1] && 0 === m[2] ? (n = m[3] - (c.x + h), p = m[0] - (c.y + k), 0 < n && 0 < p && (Math.abs(n) < Math.abs(
							p) ? h += n : k += p)) : 0 === m[2] && 0 === m[3] ? (n = e.zj() - m[1] - (d.x + h), p = m[0] - (c.y + k), 0 >
							n && 0 < p && (Math.abs(n) < Math.abs(p) ? h += n : k += p)) : 0 === m[0] && 0 === m[3] ? (n = e.zj() - m[1] -
							(d.x + h), p = e.wj() - m[2] - (d.y + k), 0 > n && 0 > p && (Math.abs(n) < Math.abs(p) ? h += n : k += p)) :
						0 === m[0] && 0 === m[1] && (n = m[3] - (c.x + h), p = e.wj() - m[2] - (d.y + k), 0 < n && 0 > p && (Math.abs(
		...
		Kna: function() {
			this.get("closeWhenClickMap") && (this.map.h("clickstart", this.w_, this, !1), this.map.h("clickend", this.v_,
				this, !1))
		},
		w_: function() {
		...
		kg: function() {
			this.Rc && this.map && (this.tf.mL = !1, this.get("closeWhenClickMap") && (this.map.G("clickstart", this.w_,
					this), this.map.G("clickend", this.v_, this)), this.get("retainWhenClose") ? this.map.Nl.appendChild(this.Rc) :
				(this.Rc.parentNode === this.map.Xa.C && this.map.Xa.C.removeChild(this.Rc), this.tf.C = null), this.map =
	...
	g.di = g.da.extend({
		...
		AU: function(a) {
			a && (this.W = a, this.X("coords", a, !0), this.wB || this.XN) && (a.X("radius", this), a.X("center", this), a.X(
				"resolution", this), a.X("strokeWeight", this))
		},
		setStyle: function(a) {
			this.Exa(a);
			this.ss()
	...
	g.M.Yb = g.da.extend({
			...
			if (Math.floor(e) !== e) b(c, f);
				...
				if (f.om) {
					for (var e = f.eh, h = !0, k = [], l = 0; l < e.length; l += 1) {
						var m = e[l].Wg;
						if (m)
							if (m.parentNode && m.parentNode.parentNode && this.J && m.parentNode.parentNode !== this.J.Nl && "none" !==
						...
						if (e.hasOwnProperty(q) &&
							...
							if (k = h.fc(), k instanceof g.Aa.Pg)
								if (this.Cj) {
									...
									g.I.Sd(m, k) && c.push(h)
								} else if ("undefined" !== typeof k.get("radius")) l = k.za, l = new g.H(l[0], l[1]), m = new g.H(a[0], a[1]),
						k = k.get("radius"), "px" === h.get("unit") ? m.He(l) / Math.pow(2, 20 - this.zoom) < k && c.push(h) : m.He(l) *
						Math.cos(h.get("center").Q * Math.PI / 180) <= k / this.Dq * Math.pow(2, 20 - this.zoom) && c.push(h);
					else if ("AMap.Text" == h.Tp) l = h.get("params"), l.visible && h.fa && g.g.HD(d, h.fa, "amap-markers") && c.push(
						h);
					else {
						if (l = h.get("params"), l.visible && h.fa)
							if (l.shape)
								for (k = k.za, s = l.Rp % 360, u = [a[0], a[1]], s && (v = (a[0] -
											k[0]) / this.T, w = (a[1] - k[1]) / this.T, t = Math.PI * s / 180, s = Math.cos(-t), x = Math.sin(-t), t =
										v * s - w * x, v = v * x + w * s, u[0] = k[0] + t * this.T, u[1] = k[1] + v * this.T), m = h.width * this
									.T, n = h.height * this.T, p = l.offset.x * this.T, r = l.offset.y * this.T, m = g.I.VP([
										[u[0] - m - p, u[1] - n - r],
										[u[0] - p, u[1] - r]
		...
		GD: function(a, b, c) {
			...
			a = a.shape;
			if ("circle" === a.w.type) {
				if (b = a.w.coords[0], c = a.w.coords[1], Math.sqrt((d[0] - b) * (d[0] - b) + (d[1] - c) * (d[1] - c)) <= a.w.coords[
						2]) return !0
			} else {
				if ("poly" ===
	...
	g.M.Rb = g.da.extend({
		...
		nq: function(a, b, c, d, e) {
			...
			for (var h = b.length, k = [], l = 0, m, n = [], p = 0; p < h; p += 1) m = b[p], (m instanceof g.o.ed ||
					"AMap.LabelLayer" === m.CLASS_NAME) &&
	...
	g.R2 = {
		...
		Xqa: function(a) {
			...
			return function(a) {
				...
				if (void 0 === e[a]) {
					var k = b.mD(a, d, e);
					e[a] = f && "none" !== f && k.eK !== k.Hz && k.Nq !== k.WD ? c.D4(k.Nq, k.WD, (a - k.Hz) / (k.eK - k.Hz), f) :
						k.Nq
				}
				return e[a]
			}
		...
		Rr: function(a, b) {
			for (var c = [], d = 0, e = a.length; d <
				e; d += 2) {
				var f = 0,
					f = "str" === b ? g.a.vb(parseInt(a.substr(d, 2), 16) / (0 === d ? 255 : 1), 3) : g.a.vb(parseInt(a.substr(d, 2),
						16) / 255, 3);
				c.push(f)
			}
					...
					if (this.Pf.hasOwnProperty(d)) {
						...
						for (var f in e)
							if (e.hasOwnProperty(f)) {
								var h = e[f];
								h ? h.Ye ? (c[d][f] = {}, b(h.Ye) ? c[d][f].Ye = h.Ye(a) : c[d][f].Ye = h.Ye, b(h.canvas) ? c[d][f].canvas =
			...
			if (this.e.B.Ei) {
				...
				if (d) {
					...
					if (d.visible) {
						...
						q && (c = this.oA(q, d.visible, "rgba(0, 0, 0, 0)"), q = this.mm(b.dt(this.e.De.substr(1)), d.opacity, d.color,
							!0, a), k = this.oA(q, d.visible))
					}
					this.e.Nu = c
				} else this.e.Nu = "";
				...
				h && (h.visible ? (n = this.mm(b.bl(this.e.WF[0]), void 0, h.fillColor, !0, a), n = this.oA(n, h.visible), p =
					this.mm(b.bl(this.e.WF[1]), void 0, h.strokeColor, !0, a), p = this.oA(p, h.visible)) : (n = [1, 1, 1, 0], p = [
					1, 1, 1, 0
				]));
		...
		lq: function(a, b, c, d, e) {
			if (a) {
				if (void 0 !== b) return a = a.split(","), c = b, "function" === typeof b && (c = b(e)), a[3] = g.a.vb(c, 3) +
					")", a.join(",");
		...
		xs: function(a, b, c, d) {
			...
			var e = null,
				f = a;
			d = d || this.Jj;
			(e = this.kJ(b, void 0, d)) && (f = "function" === typeof e.visible && !e.visible(d) || !1 === e.visible ? "" : c(
		...
		My: function(a, b, c, d, e,
			...
			f = f || this.Jj;
			var r = this.kJ(d, e, f);
			r && ("function" === typeof r.visible && !r.visible(f) || !1 === r.visible || "function" === typeof r.KU && !r.KU(
				f) || !1 === r.KU ? (n = m = !1, h = k = l = "") : (h = this.lq(a, r.lya, r.kya, !1, f), k = this.lq(b, r.oya,
					r.nya, !1, f), l = this.lq(c, r.nma, r.backgroundColor, !1, f), m = "function" === typeof r.zk ? r.zk(f) : r.zk,
		...
		Ly: function(a, b, c, d, e) {
			...
			d = d ? this.lq : this.mm;
			var l = e || this.Jj;
			if (f = this.kJ(c, void 0, e)) "function" === typeof f.visible && !f.visible(l) || !1 === f.visible ? h = k = "" :
				(h = d(a, f.ke, f.fillColor, !1, l), k = d(b, f.ob, f.strokeColor, !1, l));
	...
	g.M.canvas.Rb = g.M.Rb.extend({
		...
		pc: function(a) {
			...
			if (!this.Na || 1E4 < Math.abs(b.lb.x - this.Na.x) / this.T || 1E4 < Math.abs(b.lb.y - this.Na.y) /
				this.T) this.Na = b.lb;
			this.Na.x - b.lb.x < -g.a.Fa / 2 ? this.Na = new g.H(this.Na.x + g.a.Fa, this.Na.y) : this.Na.x - b.lb.x > g.a.Fa /
				2 && (this.Na = new g.H(this.Na.x - g.a.Fa, this.Na.y));
			for (var h = 0; h < c.length; h += 1) {
				var k = c[h],
					l = this.zs(k),
					m = c[h].le();
				if (l && l.f)
					if (!m.visible || k.XD || m.Ya[0] > b.zoom || m.Ya[1] < b.zoom || k.ga && 0 === k.ga.length) {
						if (l = l.yj())
							if (l.length)
					...
					var k = l.yj(),
						n, p, q = l.transform;
					if (!q || !k || l.bh && !this.e.B.La) c[h].Bj && k.parentNode !== this.K && (this.K.appendChild(k), c[h].Mb =
						k);
					else {
						c[h].Mb = k;
						k.length || (k = [k], q = [q]);
						for (var r = 0; r < k.length; r += 1)
							if (n = k[r], p = q[r], !p.Zy) {
								...
								c[h].XC ? (w.push("top:" + Math.floor(f / 2 + u) + "px"), w.push("left:" +
									Math.floor(e / 2 + s) + "px")) : n.J5 ? (w.push("height:" + n.height * v + "px"), w.push("width:" + n.width *
									v + "px"), w.push("top:" + (f / 2 - u * v) + "px"), w.push("left:" + (e / 2 - s * v) + "px")) : (1 !== v &&
									(w.push(g.g.pt[g.g.tg] + "-origin:" + s + "px " + u + "px"), w.push(g.g.pt[g.g.tg] + ":scale3d(" + v +
										"," + v + ",1)")), w.push("top:" + Math.floor(f / 2 - u) + "px"), w.push("left:" + Math.floor(e / 2 - s) +
										"px"), w.push("display:block"), l.ok && (w.push("height:" + n.height + "px"), w.push("width:" + n.width +
										"px")));
			...
			k = this.e.Xa.o;
			c = this.e.Xa.C;
			g.g.tg && "number" === typeof b.rotation && 0 !== b.rotation ? (a.style[g.g.tg + "Origin"] = e / 2 + "px " + f /
				2 + "px", a.style[g.g.tg] = "rotate(" + b.rotation + "deg)", a.style.overflow = "visible", k.style.overflow =
	...
	g.M.Vi = g.M.Yb.extend({
		...
		Jq: function() {
			...
			this.Lc && (this.Lc.G("tiles", this.bE, this), this.Lc.G("ack", this.aE, this), this.Lc.G("disable", this.ZD,
				this), this.Lc = null);
				...
				var e, f, h, k, l, m,
					n, p = function() {
						...
						for (e = a.length - 1; 0 <= e; e -= 1)
							for (f = a[e], h = [], k = [], f.WT = h, f.Kv = k, l = f.length - 1; 0 <= l; l -= 1) m = f[l], n = m.ta, c.f
								.e.Te.ME(n.x, n.y, n.z, function() {
									var c = l;
									return function(e) {
					...
					for (var c = a.length - 1; 0 <= c; c -= 1) {
						...
						if (d.length)
							for (var e =
								...
								if (10 > h.z) {
									var k = this.nJ(f);
									k && (f.Pb = k, f.status = "loaded", f.Ba = !0, k.kj += 1, f.un = (h.x - k.ta.x) / Math.pow(2, h.z), d.splice(
									...
									for (e = function() {
											...
											return function() {
												if (0 === --a) {
													...
													l.f.S.vk || (g.Be.nf.end(b), g.Be.nf.end(g.extend(b, {
														index: 1
													})))
												}
											}
		...
		hp: function(a, b) {
			...
			this.zoom = c.zoom;
			this.me = c.me;
			this.fb = "AMap.MapBox" == this.f.S.CLASS_NAME ? Math.max(2, this.me - g.r.Xn) : !1 === this.Fi && !this.f.qS &&
				this.f.ja ? this.me + 1 : this.me;
			...
			for (q = m.length - 1; 0 <= q; q -= 1)
				...
				if (s[p + ""] |= 64, this.aj)
					for (x = this.fb - p.z, v = Math.max(c.Jc, p.x << x), r = Math.min(c.Ic, (p.x + 1 << x) - 1), w = Math.max(c.hc,
							p.y << x), t = Math.min(c.tc, (p.y + 1 << x) - 1), p.z = this.fb, x = v; x <= r; x += 1)
						for (p.x = x, y = w; y <= t; y += 1) p.y = y, F = p + "", s[F] |= 32, u[F] = u[F] ? Math.max(k.ta.z, u[F]) :
							k.ta.z
			} else if (this.$i)
				for (v = 1; p.z >= this.fb;) {
					s[p + ""] |= v;
			...
			for (x = e.Jc; x <= e.Ic; x += 1)
				for (p.x = x, y = e.hc; y <= e.tc; y += 1) p.y = y, k = this.Sy(p), this.bu(k), v = !1, k.Ba ? (k.de = this.de,
						this.uv(c, x, y) && (m.push(k), this.Pk && (k.gd !== this.gd || 1 > k.hx) && (v = !0))) : (q = !1, this.uv(c,
						x, y) && (v = !0), k.status && !k.Ke || this.me !== d || this.Gw && !this.uv(this.Gw, x, y) || l.push(k)), v &&
					n.push(k);
			...
			if (!d && this.aj)
				for (x = !f.length || this.ok ? b.Ya[0] : Math.max(b.Ya[0], this.fb - 2), Math.max(x, this.fb - this.aha), r =
					this.fb - 1; n.length && r >= x; r -= 1) {
					m = [];
					y = {};
					l = n;
					n = [];
					for (q = l.length - 1; 0 <= q; q -= 1) k = l[q], p.z = r, p.x = k.ta.x >> 1, p.y = k.ta.y >> 1, k = this.Sy(p),
						y[k.key] || (y[k.key] = 1, v = !1, k.Ba && (!this.aja || s[k.key] & 64) ? (p.x = Math.min(c.Ic, Math.max(c.Jc,
								p.x << this.fb - r)), p.y = Math.min(c.tc, Math.max(c.hc, p.y << this.fb -
								r)), p.z = this.fb, F = p + "", "number" === typeof u[F] && k.ta.z > u[F] ? v = !0 : k.IB = !0, k.de =
							this.de, m.push(k), this.bu(k)) : v = !0, v && n.push(k));
					m.length && f.push(m)
				}
			this.dV = h;
			this.Fv = this.Aq = 0;
		...
		PM: function() {
			var a = this.e.B;
			return a.V7 && a.get("preloadMode") && 200 <= this.oa.Ip && this.f.S.wq() && "stable" != this.Lf && this.Yx &&
				this.Yx() && this.zoom !== this.fb
		},
		Rv: function(a, b) {
			var c = b.I,
				d = b.Ya;
	...
	g.M.ae.Vi = g.M.Vi.extend({
		...
		Vv: function() {
			for (var a = this.Mb.childNodes, b = a.length - 1; 0 <= b; b -= 1) a[b] && a[b].gd !== this.gd && this.Mb.removeChild(
				a[b])
		},
		pE: function(a, b) {
			...
			for (d = a.length -
				...
				if (f = a[d], f.length) {
					...
					for (var r = f.length - 1; 0 <= r; r -= 1) {
						...
						m = n.ta;
						var c = !0,
							u = (new g.H((m.x << 20 - e) * this.Dd, (m.y << 20 - e) * this.Dd)).ab(this.Na),
							u = u.kd(this.Kg);
						u.x = g.a.vb(u.x, 1);
						u.y = g.a.vb(u.y, 1);
						var v = 1;
						if (!n.iY || this.nX && n.gd !== b) n.iY = this.currentTime;
						this.Pk && !n.IB ? (s = Math.max(0, Math.abs(m.z - this.zoom) - 1), v = Math.min(1, (this.currentTime - n.iY) /
							(1 / Math.pow(1.32, s) * this.bo)), 1 !== v && (this.xe = !0)) : n.IB = !1;
						n.gd = this.gd;
						n.hx = v;
						n.Ba ? (s = n.Fe, !s && n.Pb && n.Pb.Fe && (s = n.Pb.Fe), 0 !== v && s && (this.e4(s, u.x, u.y, p, p, v, m.z),
							s.parentNode !== this.Mb && (g.l.Ci && "overlayer" === this.f.get("type") && (s.style.display = "none"),
								this.bv.appendChild(s)), s.gd = this.gd, n.me = this.me, h.push(n))) : n.de = null
					}
					e = !0
				} this.mk &&
	...
	window.CanvasRenderingContext2D && (window.CanvasRenderingContext2D.prototype.EQ = function(a, b, c, d, e) {
		...
		for (p = 0; n + p <= k;) n < e[m] ? (f = n * d, h = n * c) : (f = l[m].bD, h = l[m].cD), a += f, b += h, this.GE ?
			this.moveTo(a, b) : this.lineTo(a, b), p += n, this.GE = !this.GE, n = e[(m + 1) %
			...
			for (f in a)
				if (a.hasOwnProperty(f)) {
					...
					if (!m)
						...
						} else if (h.bba || this.zoom << 0 !== this.zoom || h.zoom !== this.zoom || k.parentNode !== this.rl || h.Na !==
						this.Na) x = this.Ku(h.W.za), h.Na = this.Na, y = l.oF,
	...
	(typeof _cssload_ == "function") && _cssload_("logo", ".amap-logo{display:block!important;pointer-events:none;}",
		true)
})(["3adbc80950e306447ef70479a70197f8", [107.663753, 33.693877, 109.822432, 34.743104, 108.948024, 34.263161],
	"https://webapi.amap.com", 1, "1.4.15", null, "610100", "AMap.MouseTool", true, false, false, true,
	"1603299911-20201123-1", false, "C", "3_20_12_18_00"
])
